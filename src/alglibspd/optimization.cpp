...
#include "spd/alglibspd/optimization.h"
...
{
    p_struct = (spd_alglib_impl::mincgstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::mincgstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_mincgstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_mincgstate_owner::_mincgstate_owner(const _mincgstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_mincgstate_init_copy(p_struct, const_cast<spd_alglib_impl::mincgstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_mincgstate_owner& _mincgstate_owner::operator=(const _mincgstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_mincgstate_clear(p_struct);
    if( !spd_alglib_impl::_mincgstate_init_copy(p_struct, const_cast<spd_alglib_impl::mincgstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::mincgstate* _mincgstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::mincgstate* _mincgstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::mincgstate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::mincgreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::mincgreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_mincgreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_mincgreport_owner::_mincgreport_owner(const _mincgreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_mincgreport_init_copy(p_struct, const_cast<spd_alglib_impl::mincgreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_mincgreport_owner& _mincgreport_owner::operator=(const _mincgreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_mincgreport_clear(p_struct);
    if( !spd_alglib_impl::_mincgreport_init_copy(p_struct, const_cast<spd_alglib_impl::mincgreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::mincgreport* _mincgreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::mincgreport* _mincgreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::mincgreport*>(p_struct);
}
...
void mincgcreate(const ae_int_t n, const real_1d_array &x, mincgstate &state)
{
    ...
    spd_alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        spd_alglib_impl::mincgcreate(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
    {
...
void mincgcreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, mincgstate &state)
{
    ...
    try
    {
        spd_alglib_impl::mincgcreatef(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), diffstep, const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetcond(const mincgstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetcond(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), epsg, epsf, epsx, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetscale(const mincgstate &state, const real_1d_array &s)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetscale(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(s.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetxrep(const mincgstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetxrep(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetcgtype(const mincgstate &state, const ae_int_t cgtype)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetcgtype(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), cgtype, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetstpmax(const mincgstate &state, const double stpmax)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetstpmax(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), stpmax, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsuggeststep(const mincgstate &state, const double stp)
{
    ...
    try
    {
        spd_alglib_impl::mincgsuggeststep(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), stp, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetprecdefault(const mincgstate &state)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetprecdefault(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetprecdiag(const mincgstate &state, const real_1d_array &d)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetprecdiag(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(d.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetprecscale(const mincgstate &state)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetprecscale(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool mincgiteration(const mincgstate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::mincgiteration(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
    ...
    void *ptr)
{
    ...
    try
    {
        while( spd_alglib_impl::mincgiteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needf )
            {
...
void mincgresults(const mincgstate &state, real_1d_array &x, mincgreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::mincgresults(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::mincgreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgresultsbuf(const mincgstate &state, real_1d_array &x, mincgreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::mincgresultsbuf(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::mincgreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgrestartfrom(const mincgstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::mincgrestartfrom(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void mincgsetgradientcheck(const mincgstate &state, const double teststep)
{
    ...
    try
    {
        spd_alglib_impl::mincgsetgradientcheck(const_cast<spd_alglib_impl::mincgstate*>(state.c_ptr()), teststep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::minbleicstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minbleicstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minbleicstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minbleicstate_owner::_minbleicstate_owner(const _minbleicstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minbleicstate_init_copy(p_struct, const_cast<spd_alglib_impl::minbleicstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minbleicstate_owner& _minbleicstate_owner::operator=(const _minbleicstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minbleicstate_clear(p_struct);
    if( !spd_alglib_impl::_minbleicstate_init_copy(p_struct, const_cast<spd_alglib_impl::minbleicstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minbleicstate* _minbleicstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minbleicstate* _minbleicstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minbleicstate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::minbleicreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minbleicreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minbleicreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minbleicreport_owner::_minbleicreport_owner(const _minbleicreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minbleicreport_init_copy(p_struct, const_cast<spd_alglib_impl::minbleicreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minbleicreport_owner& _minbleicreport_owner::operator=(const _minbleicreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minbleicreport_clear(p_struct);
    if( !spd_alglib_impl::_minbleicreport_init_copy(p_struct, const_cast<spd_alglib_impl::minbleicreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minbleicreport* _minbleicreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minbleicreport* _minbleicreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minbleicreport*>(p_struct);
}
...
void minbleiccreate(const ae_int_t n, const real_1d_array &x, minbleicstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minbleiccreate(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleiccreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, minbleicstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minbleiccreatef(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), diffstep, const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetbc(const minbleicstate &state, const real_1d_array &bndl, const real_1d_array &bndu)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetbc(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndl.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndu.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetlc(const minbleicstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetlc(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(c.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(ct.c_ptr()), k, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetcond(const minbleicstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetcond(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), epsg, epsf, epsx, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetscale(const minbleicstate &state, const real_1d_array &s)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetscale(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(s.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetprecdefault(const minbleicstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetprecdefault(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetprecdiag(const minbleicstate &state, const real_1d_array &d)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetprecdiag(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(d.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetprecscale(const minbleicstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetprecscale(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetxrep(const minbleicstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetxrep(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetstpmax(const minbleicstate &state, const double stpmax)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetstpmax(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), stpmax, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool minbleiciteration(const minbleicstate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::minbleiciteration(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<bool*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
    ...
    void *ptr)
{
    ...
    try
    {
        while( spd_alglib_impl::minbleiciteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needf )
            {
                func(state.x, state.f, ptr);
...
void minbleicresults(const minbleicstate &state, real_1d_array &x, minbleicreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minbleicresults(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minbleicreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicresultsbuf(const minbleicstate &state, real_1d_array &x, minbleicreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minbleicresultsbuf(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minbleicreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicrestartfrom(const minbleicstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::minbleicrestartfrom(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetgradientcheck(const minbleicstate &state, const double teststep)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetgradientcheck(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), teststep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::minlbfgsstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minlbfgsstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlbfgsstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlbfgsstate_owner::_minlbfgsstate_owner(const _minlbfgsstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlbfgsstate_init_copy(p_struct, const_cast<spd_alglib_impl::minlbfgsstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlbfgsstate_owner& _minlbfgsstate_owner::operator=(const _minlbfgsstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minlbfgsstate_clear(p_struct);
    if( !spd_alglib_impl::_minlbfgsstate_init_copy(p_struct, const_cast<spd_alglib_impl::minlbfgsstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minlbfgsstate* _minlbfgsstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minlbfgsstate* _minlbfgsstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minlbfgsstate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::minlbfgsreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minlbfgsreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlbfgsreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlbfgsreport_owner::_minlbfgsreport_owner(const _minlbfgsreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlbfgsreport_init_copy(p_struct, const_cast<spd_alglib_impl::minlbfgsreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlbfgsreport_owner& _minlbfgsreport_owner::operator=(const _minlbfgsreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minlbfgsreport_clear(p_struct);
    if( !spd_alglib_impl::_minlbfgsreport_init_copy(p_struct, const_cast<spd_alglib_impl::minlbfgsreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minlbfgsreport* _minlbfgsreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minlbfgsreport* _minlbfgsreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minlbfgsreport*>(p_struct);
}
...
void minlbfgscreate(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlbfgsstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgscreate(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgscreatef(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const double diffstep, minlbfgsstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgscreatef(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), diffstep, const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetcond(const minlbfgsstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetcond(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), epsg, epsf, epsx, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetxrep(const minlbfgsstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetxrep(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetstpmax(const minlbfgsstate &state, const double stpmax)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetstpmax(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), stpmax, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetscale(const minlbfgsstate &state, const real_1d_array &s)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetscale(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(s.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetprecdefault(const minlbfgsstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetprecdefault(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetpreccholesky(const minlbfgsstate &state, const real_2d_array &p, const bool isupper)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetpreccholesky(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(p.c_ptr()), isupper, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetprecdiag(const minlbfgsstate &state, const real_1d_array &d)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetprecdiag(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(d.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetprecscale(const minlbfgsstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetprecscale(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool minlbfgsiteration(const minlbfgsstate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::minlbfgsiteration(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<bool*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
    ...
    void *ptr)
{
    ...
    try
    {
        while( spd_alglib_impl::minlbfgsiteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needf )
            {
                func(state.x, state.f, ptr);
...
void minlbfgsresults(const minlbfgsstate &state, real_1d_array &x, minlbfgsreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgsresults(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlbfgsreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgsresultsbuf(const minlbfgsstate &state, real_1d_array &x, minlbfgsreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgsresultsbuf(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlbfgsreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgsrestartfrom(const minlbfgsstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgsrestartfrom(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetgradientcheck(const minlbfgsstate &state, const double teststep)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetgradientcheck(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), teststep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::minqpstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minqpstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minqpstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minqpstate_owner::_minqpstate_owner(const _minqpstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minqpstate_init_copy(p_struct, const_cast<spd_alglib_impl::minqpstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minqpstate_owner& _minqpstate_owner::operator=(const _minqpstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minqpstate_clear(p_struct);
    if( !spd_alglib_impl::_minqpstate_init_copy(p_struct, const_cast<spd_alglib_impl::minqpstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minqpstate* _minqpstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minqpstate* _minqpstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minqpstate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::minqpreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minqpreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minqpreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minqpreport_owner::_minqpreport_owner(const _minqpreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minqpreport_init_copy(p_struct, const_cast<spd_alglib_impl::minqpreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minqpreport_owner& _minqpreport_owner::operator=(const _minqpreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minqpreport_clear(p_struct);
    if( !spd_alglib_impl::_minqpreport_init_copy(p_struct, const_cast<spd_alglib_impl::minqpreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minqpreport* _minqpreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minqpreport* _minqpreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minqpreport*>(p_struct);
}
...
void minqpcreate(const ae_int_t n, minqpstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minqpcreate(n, const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetlinearterm(const minqpstate &state, const real_1d_array &b)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetlinearterm(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetquadraticterm(const minqpstate &state, const real_2d_array &a, const bool isupper)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetquadraticterm(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), isupper, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetquadraticterm(const minqpstate &state, const real_2d_array &a)
{
    spd_alglib_impl::ae_state _alglib_env_state;    
    bool isupper;
    if( !spd_alglib_impl::ae_is_symmetric(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr())) )
...
void minqpsetquadratictermsparse(const minqpstate &state, const sparsematrix &a, const bool isupper)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetquadratictermsparse(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::sparsematrix*>(a.c_ptr()), isupper, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetstartingpoint(const minqpstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetstartingpoint(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetorigin(const minqpstate &state, const real_1d_array &xorigin)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetorigin(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(xorigin.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetscale(const minqpstate &state, const real_1d_array &s)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetscale(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(s.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetalgocholesky(const minqpstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetalgocholesky(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetalgobleic(const minqpstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetalgobleic(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), epsg, epsf, epsx, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetbc(const minqpstate &state, const real_1d_array &bndl, const real_1d_array &bndu)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetbc(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndl.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndu.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpsetlc(const minqpstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k)
{
    ...
    try
    {
        spd_alglib_impl::minqpsetlc(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(c.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(ct.c_ptr()), k, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpoptimize(const minqpstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minqpoptimize(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpresults(const minqpstate &state, real_1d_array &x, minqpreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minqpresults(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minqpreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minqpresultsbuf(const minqpstate &state, real_1d_array &x, minqpreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minqpresultsbuf(const_cast<spd_alglib_impl::minqpstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minqpreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::minlmstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minlmstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlmstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlmstate_owner::_minlmstate_owner(const _minlmstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlmstate_init_copy(p_struct, const_cast<spd_alglib_impl::minlmstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlmstate_owner& _minlmstate_owner::operator=(const _minlmstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minlmstate_clear(p_struct);
    if( !spd_alglib_impl::_minlmstate_init_copy(p_struct, const_cast<spd_alglib_impl::minlmstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minlmstate* _minlmstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minlmstate* _minlmstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minlmstate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::minlmreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minlmreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlmreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlmreport_owner::_minlmreport_owner(const _minlmreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minlmreport_init_copy(p_struct, const_cast<spd_alglib_impl::minlmreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minlmreport_owner& _minlmreport_owner::operator=(const _minlmreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minlmreport_clear(p_struct);
    if( !spd_alglib_impl::_minlmreport_init_copy(p_struct, const_cast<spd_alglib_impl::minlmreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minlmreport* _minlmreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minlmreport* _minlmreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minlmreport*>(p_struct);
}
...
void minlmcreatevj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlmcreatevj(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmcreatev(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const double diffstep, minlmstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlmcreatev(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), diffstep, const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmcreatefgh(const ae_int_t n, const real_1d_array &x, minlmstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlmcreatefgh(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetcond(const minlmstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetcond(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), epsg, epsf, epsx, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetxrep(const minlmstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetxrep(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetstpmax(const minlmstate &state, const double stpmax)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetstpmax(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), stpmax, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetscale(const minlmstate &state, const real_1d_array &s)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetscale(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(s.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetbc(const minlmstate &state, const real_1d_array &bndl, const real_1d_array &bndu)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetbc(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndl.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndu.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetacctype(const minlmstate &state, const ae_int_t acctype)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetacctype(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), acctype, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool minlmiteration(const minlmstate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::minlmiteration(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<bool*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
    ...
    void *ptr)
{
    ...
    try
    {
        while( spd_alglib_impl::minlmiteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needfi )
            {
...
void minlmresults(const minlmstate &state, real_1d_array &x, minlmreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minlmresults(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmresultsbuf(const minlmstate &state, real_1d_array &x, minlmreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minlmresultsbuf(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmrestartfrom(const minlmstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::minlmrestartfrom(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmcreatevgj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlmcreatevgj(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmcreatefgj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlmcreatefgj(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmcreatefj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlmcreatefj(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlmsetgradientcheck(const minlmstate &state, const double teststep)
{
    ...
    try
    {
        spd_alglib_impl::minlmsetgradientcheck(const_cast<spd_alglib_impl::minlmstate*>(state.c_ptr()), teststep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::minasastate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minasastate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minasastate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minasastate_owner::_minasastate_owner(const _minasastate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minasastate_init_copy(p_struct, const_cast<spd_alglib_impl::minasastate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minasastate_owner& _minasastate_owner::operator=(const _minasastate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minasastate_clear(p_struct);
    if( !spd_alglib_impl::_minasastate_init_copy(p_struct, const_cast<spd_alglib_impl::minasastate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minasastate* _minasastate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minasastate* _minasastate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minasastate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::minasareport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::minasareport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minasareport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minasareport_owner::_minasareport_owner(const _minasareport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_minasareport_init_copy(p_struct, const_cast<spd_alglib_impl::minasareport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_minasareport_owner& _minasareport_owner::operator=(const _minasareport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_minasareport_clear(p_struct);
    if( !spd_alglib_impl::_minasareport_init_copy(p_struct, const_cast<spd_alglib_impl::minasareport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::minasareport* _minasareport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::minasareport* _minasareport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::minasareport*>(p_struct);
}
...
void minlbfgssetdefaultpreconditioner(const minlbfgsstate &state)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetdefaultpreconditioner(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minlbfgssetcholeskypreconditioner(const minlbfgsstate &state, const real_2d_array &p, const bool isupper)
{
    ...
    try
    {
        spd_alglib_impl::minlbfgssetcholeskypreconditioner(const_cast<spd_alglib_impl::minlbfgsstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(p.c_ptr()), isupper, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetbarrierwidth(const minbleicstate &state, const double mu)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetbarrierwidth(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), mu, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minbleicsetbarrierdecay(const minbleicstate &state, const double mudecay)
{
    ...
    try
    {
        spd_alglib_impl::minbleicsetbarrierdecay(const_cast<spd_alglib_impl::minbleicstate*>(state.c_ptr()), mudecay, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasacreate(const ae_int_t n, const real_1d_array &x, const real_1d_array &bndl, const real_1d_array &bndu, minasastate &state)
{
    ...
    try
    {
        spd_alglib_impl::minasacreate(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndl.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndu.c_ptr()), const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasasetcond(const minasastate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::minasasetcond(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), epsg, epsf, epsx, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasasetxrep(const minasastate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::minasasetxrep(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasasetalgorithm(const minasastate &state, const ae_int_t algotype)
{
    ...
    try
    {
        spd_alglib_impl::minasasetalgorithm(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), algotype, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasasetstpmax(const minasastate &state, const double stpmax)
{
    ...
    try
    {
        spd_alglib_impl::minasasetstpmax(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), stpmax, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool minasaiteration(const minasastate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::minasaiteration(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<bool*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
    ...
    void *ptr)
{
    ...
    try
    {
        while( spd_alglib_impl::minasaiteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needfg )
            {
                grad(state.x, state.f, state.g, ptr);
...
void minasaresults(const minasastate &state, real_1d_array &x, minasareport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minasaresults(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minasareport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasaresultsbuf(const minasastate &state, real_1d_array &x, minasareport &rep)
{
    ...
    try
    {
        spd_alglib_impl::minasaresultsbuf(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::minasareport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void minasarestartfrom(const minasastate &state, const real_1d_array &x, const real_1d_array &bndl, const real_1d_array &bndu)
{
    ...
    try
    {
        spd_alglib_impl::minasarestartfrom(const_cast<spd_alglib_impl::minasastate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndl.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(bndu.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
