...
void gqgeneraterec(const real_1d_array &alpha, const real_1d_array &beta, const double mu0, const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgeneraterec(const_cast<spd_alglib_impl::ae_vector*>(alpha.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(beta.c_ptr()), mu0, n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
...
void gqgenerategausslobattorec(const real_1d_array &alpha, const real_1d_array &beta, const double mu0, const double a, const double b, const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgenerategausslobattorec(const_cast<spd_alglib_impl::ae_vector*>(alpha.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(beta.c_ptr()), mu0, a, b, n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gqgenerategaussradaurec(const real_1d_array &alpha, const real_1d_array &beta, const double mu0, const double a, const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgenerategaussradaurec(const_cast<spd_alglib_impl::ae_vector*>(alpha.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(beta.c_ptr()), mu0, a, n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gqgenerategausslegendre(const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgenerategausslegendre(n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gqgenerategaussjacobi(const ae_int_t n, const double alpha, const double beta, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgenerategaussjacobi(n, alpha, beta, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gqgenerategausslaguerre(const ae_int_t n, const double alpha, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgenerategausslaguerre(n, alpha, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gqgenerategausshermite(const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &w)
{
    ...
    try
    {
        spd_alglib_impl::gqgenerategausshermite(n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(w.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gkqgeneraterec(const real_1d_array &alpha, const real_1d_array &beta, const double mu0, const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &wkronrod, real_1d_array &wgauss)
{
    ...
    try
    {
        spd_alglib_impl::gkqgeneraterec(const_cast<spd_alglib_impl::ae_vector*>(alpha.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(beta.c_ptr()), mu0, n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wkronrod.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wgauss.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gkqgenerategausslegendre(const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &wkronrod, real_1d_array &wgauss)
{
    ...
    try
    {
        spd_alglib_impl::gkqgenerategausslegendre(n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wkronrod.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wgauss.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gkqgenerategaussjacobi(const ae_int_t n, const double alpha, const double beta, ae_int_t &info, real_1d_array &x, real_1d_array &wkronrod, real_1d_array &wgauss)
{
    ...
    try
    {
        spd_alglib_impl::gkqgenerategaussjacobi(n, alpha, beta, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wkronrod.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wgauss.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gkqlegendrecalc(const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &wkronrod, real_1d_array &wgauss)
{
    ...
    try
    {
        spd_alglib_impl::gkqlegendrecalc(n, &info, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wkronrod.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wgauss.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void gkqlegendretbl(const ae_int_t n, real_1d_array &x, real_1d_array &wkronrod, real_1d_array &wgauss, double &eps)
{
    ...
    try
    {
        spd_alglib_impl::gkqlegendretbl(n, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wkronrod.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(wgauss.c_ptr()), &eps, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::autogkreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::autogkreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_autogkreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_autogkreport_owner::_autogkreport_owner(const _autogkreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_autogkreport_init_copy(p_struct, const_cast<spd_alglib_impl::autogkreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_autogkreport_owner& _autogkreport_owner::operator=(const _autogkreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_autogkreport_clear(p_struct);
    if( !spd_alglib_impl::_autogkreport_init_copy(p_struct, const_cast<spd_alglib_impl::autogkreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::autogkreport* _autogkreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::autogkreport* _autogkreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::autogkreport*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::autogkstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::autogkstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_autogkstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_autogkstate_owner::_autogkstate_owner(const _autogkstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_autogkstate_init_copy(p_struct, const_cast<spd_alglib_impl::autogkstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_autogkstate_owner& _autogkstate_owner::operator=(const _autogkstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_autogkstate_clear(p_struct);
    if( !spd_alglib_impl::_autogkstate_init_copy(p_struct, const_cast<spd_alglib_impl::autogkstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::autogkstate* _autogkstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::autogkstate* _autogkstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::autogkstate*>(p_struct);
}
...
void autogksmooth(const double a, const double b, autogkstate &state)
{
    ...
    try
    {
        spd_alglib_impl::autogksmooth(a, b, const_cast<spd_alglib_impl::autogkstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void autogksmoothw(const double a, const double b, const double xwidth, autogkstate &state)
{
    ...
    try
    {
        spd_alglib_impl::autogksmoothw(a, b, xwidth, const_cast<spd_alglib_impl::autogkstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void autogksingular(const double a, const double b, const double alpha, const double beta, autogkstate &state)
{
    ...
    try
    {
        spd_alglib_impl::autogksingular(a, b, alpha, beta, const_cast<spd_alglib_impl::autogkstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool autogkiteration(const autogkstate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::autogkiteration(const_cast<spd_alglib_impl::autogkstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
...
void autogkintegrate(autogkstate &state,
    ...
    try
    {
        while( spd_alglib_impl::autogkiteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needf )
            {
...
void autogkresults(const autogkstate &state, double &v, autogkreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::autogkresults(const_cast<spd_alglib_impl::autogkstate*>(state.c_ptr()), &v, const_cast<spd_alglib_impl::autogkreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
