...
#include "spd/alglibspd/solvers.h"
...
{
    p_struct = (spd_alglib_impl::densesolverreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::densesolverreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_densesolverreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_densesolverreport_owner::_densesolverreport_owner(const _densesolverreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_densesolverreport_init_copy(p_struct, const_cast<spd_alglib_impl::densesolverreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_densesolverreport_owner& _densesolverreport_owner::operator=(const _densesolverreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_densesolverreport_clear(p_struct);
    if( !spd_alglib_impl::_densesolverreport_init_copy(p_struct, const_cast<spd_alglib_impl::densesolverreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::densesolverreport* _densesolverreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::densesolverreport* _densesolverreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::densesolverreport*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::densesolverlsreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::densesolverlsreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_densesolverlsreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_densesolverlsreport_owner::_densesolverlsreport_owner(const _densesolverlsreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_densesolverlsreport_init_copy(p_struct, const_cast<spd_alglib_impl::densesolverlsreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_densesolverlsreport_owner& _densesolverlsreport_owner::operator=(const _densesolverlsreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_densesolverlsreport_clear(p_struct);
    if( !spd_alglib_impl::_densesolverlsreport_init_copy(p_struct, const_cast<spd_alglib_impl::densesolverlsreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::densesolverlsreport* _densesolverlsreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::densesolverlsreport* _densesolverlsreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::densesolverlsreport*>(p_struct);
}
...
void rmatrixsolve(const real_2d_array &a, const ae_int_t n, const real_1d_array &b, ae_int_t &info, densesolverreport &rep, real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixsolve(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
...
void rmatrixsolvem(const real_2d_array &a, const ae_int_t n, const real_2d_array &b, const ae_int_t m, const bool rfs, ae_int_t &info, densesolverreport &rep, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixsolvem(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, rfs, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void rmatrixlusolve(const real_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const real_1d_array &b, ae_int_t &info, densesolverreport &rep, real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixlusolve(const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void rmatrixlusolvem(const real_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const real_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixlusolvem(const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void rmatrixmixedsolve(const real_2d_array &a, const real_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const real_1d_array &b, ae_int_t &info, densesolverreport &rep, real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixmixedsolve(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void rmatrixmixedsolvem(const real_2d_array &a, const real_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const real_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixmixedsolvem(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void cmatrixsolvem(const complex_2d_array &a, const ae_int_t n, const complex_2d_array &b, const ae_int_t m, const bool rfs, ae_int_t &info, densesolverreport &rep, complex_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::cmatrixsolvem(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, rfs, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void cmatrixsolve(const complex_2d_array &a, const ae_int_t n, const complex_1d_array &b, ae_int_t &info, densesolverreport &rep, complex_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::cmatrixsolve(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void cmatrixlusolvem(const complex_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const complex_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, complex_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::cmatrixlusolvem(const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void cmatrixlusolve(const complex_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const complex_1d_array &b, ae_int_t &info, densesolverreport &rep, complex_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::cmatrixlusolve(const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void cmatrixmixedsolvem(const complex_2d_array &a, const complex_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const complex_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, complex_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::cmatrixmixedsolvem(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void cmatrixmixedsolve(const complex_2d_array &a, const complex_2d_array &lua, const integer_1d_array &p, const ae_int_t n, const complex_1d_array &b, ae_int_t &info, densesolverreport &rep, complex_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::cmatrixmixedsolve(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(lua.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(p.c_ptr()), n, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void spdmatrixsolvem(const real_2d_array &a, const ae_int_t n, const bool isupper, const real_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::spdmatrixsolvem(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void spdmatrixsolve(const real_2d_array &a, const ae_int_t n, const bool isupper, const real_1d_array &b, ae_int_t &info, densesolverreport &rep, real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::spdmatrixsolve(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void spdmatrixcholeskysolvem(const real_2d_array &cha, const ae_int_t n, const bool isupper, const real_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::spdmatrixcholeskysolvem(const_cast<spd_alglib_impl::ae_matrix*>(cha.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void spdmatrixcholeskysolve(const real_2d_array &cha, const ae_int_t n, const bool isupper, const real_1d_array &b, ae_int_t &info, densesolverreport &rep, real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::spdmatrixcholeskysolve(const_cast<spd_alglib_impl::ae_matrix*>(cha.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void hpdmatrixsolvem(const complex_2d_array &a, const ae_int_t n, const bool isupper, const complex_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, complex_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::hpdmatrixsolvem(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void hpdmatrixsolve(const complex_2d_array &a, const ae_int_t n, const bool isupper, const complex_1d_array &b, ae_int_t &info, densesolverreport &rep, complex_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::hpdmatrixsolve(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void hpdmatrixcholeskysolvem(const complex_2d_array &cha, const ae_int_t n, const bool isupper, const complex_2d_array &b, const ae_int_t m, ae_int_t &info, densesolverreport &rep, complex_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::hpdmatrixcholeskysolvem(const_cast<spd_alglib_impl::ae_matrix*>(cha.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_matrix*>(b.c_ptr()), m, &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void hpdmatrixcholeskysolve(const complex_2d_array &cha, const ae_int_t n, const bool isupper, const complex_1d_array &b, ae_int_t &info, densesolverreport &rep, complex_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::hpdmatrixcholeskysolve(const_cast<spd_alglib_impl::ae_matrix*>(cha.c_ptr()), n, isupper, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &info, const_cast<spd_alglib_impl::densesolverreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void rmatrixsolvels(const real_2d_array &a, const ae_int_t nrows, const ae_int_t ncols, const real_1d_array &b, const double threshold, ae_int_t &info, densesolverlsreport &rep, real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::rmatrixsolvels(const_cast<spd_alglib_impl::ae_matrix*>(a.c_ptr()), nrows, ncols, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), threshold, &info, const_cast<spd_alglib_impl::densesolverlsreport*>(rep.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::linlsqrstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::linlsqrstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_linlsqrstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_linlsqrstate_owner::_linlsqrstate_owner(const _linlsqrstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_linlsqrstate_init_copy(p_struct, const_cast<spd_alglib_impl::linlsqrstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_linlsqrstate_owner& _linlsqrstate_owner::operator=(const _linlsqrstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_linlsqrstate_clear(p_struct);
    if( !spd_alglib_impl::_linlsqrstate_init_copy(p_struct, const_cast<spd_alglib_impl::linlsqrstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::linlsqrstate* _linlsqrstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::linlsqrstate* _linlsqrstate_owner::c_ptr() const
{
...
{
    p_struct = (spd_alglib_impl::linlsqrreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::linlsqrreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_linlsqrreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_linlsqrreport_owner::_linlsqrreport_owner(const _linlsqrreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_linlsqrreport_init_copy(p_struct, const_cast<spd_alglib_impl::linlsqrreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_linlsqrreport_owner& _linlsqrreport_owner::operator=(const _linlsqrreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_linlsqrreport_clear(p_struct);
    if( !spd_alglib_impl::_linlsqrreport_init_copy(p_struct, const_cast<spd_alglib_impl::linlsqrreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::linlsqrreport* _linlsqrreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::linlsqrreport* _linlsqrreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::linlsqrreport*>(p_struct);
}
...
void linlsqrcreate(const ae_int_t m, const ae_int_t n, linlsqrstate &state)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrcreate(m, n, const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrsetprecunit(const linlsqrstate &state)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrsetprecunit(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrsetprecdiag(const linlsqrstate &state)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrsetprecdiag(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrsetlambdai(const linlsqrstate &state, const double lambdai)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrsetlambdai(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), lambdai, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrsolvesparse(const linlsqrstate &state, const sparsematrix &a, const real_1d_array &b)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrsolvesparse(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), const_cast<spd_alglib_impl::sparsematrix*>(a.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrsetcond(const linlsqrstate &state, const double epsa, const double epsb, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrsetcond(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), epsa, epsb, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrresults(const linlsqrstate &state, real_1d_array &x, linlsqrreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrresults(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::linlsqrreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void linlsqrsetxrep(const linlsqrstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::linlsqrsetxrep(const_cast<spd_alglib_impl::linlsqrstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::lincgstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::lincgstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_lincgstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_lincgstate_owner::_lincgstate_owner(const _lincgstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_lincgstate_init_copy(p_struct, const_cast<spd_alglib_impl::lincgstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_lincgstate_owner& _lincgstate_owner::operator=(const _lincgstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_lincgstate_clear(p_struct);
    if( !spd_alglib_impl::_lincgstate_init_copy(p_struct, const_cast<spd_alglib_impl::lincgstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::lincgstate* _lincgstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::lincgstate* _lincgstate_owner::c_ptr() const
{
...
{
    p_struct = (spd_alglib_impl::lincgreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::lincgreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_lincgreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_lincgreport_owner::_lincgreport_owner(const _lincgreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_lincgreport_init_copy(p_struct, const_cast<spd_alglib_impl::lincgreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_lincgreport_owner& _lincgreport_owner::operator=(const _lincgreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_lincgreport_clear(p_struct);
    if( !spd_alglib_impl::_lincgreport_init_copy(p_struct, const_cast<spd_alglib_impl::lincgreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::lincgreport* _lincgreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::lincgreport* _lincgreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::lincgreport*>(p_struct);
}
...
void lincgcreate(const ae_int_t n, lincgstate &state)
{
    ...
    try
    {
        spd_alglib_impl::lincgcreate(n, const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetstartingpoint(const lincgstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetstartingpoint(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetprecunit(const lincgstate &state)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetprecunit(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetprecdiag(const lincgstate &state)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetprecdiag(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetcond(const lincgstate &state, const double epsf, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetcond(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), epsf, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsolvesparse(const lincgstate &state, const sparsematrix &a, const bool isupper, const real_1d_array &b)
{
    ...
    try
    {
        spd_alglib_impl::lincgsolvesparse(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::sparsematrix*>(a.c_ptr()), isupper, const_cast<spd_alglib_impl::ae_vector*>(b.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgresults(const lincgstate &state, real_1d_array &x, lincgreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::lincgresults(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::lincgreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetrestartfreq(const lincgstate &state, const ae_int_t srf)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetrestartfreq(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), srf, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetrupdatefreq(const lincgstate &state, const ae_int_t freq)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetrupdatefreq(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), freq, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void lincgsetxrep(const lincgstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::lincgsetxrep(const_cast<spd_alglib_impl::lincgstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::nleqstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::nleqstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_nleqstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_nleqstate_owner::_nleqstate_owner(const _nleqstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_nleqstate_init_copy(p_struct, const_cast<spd_alglib_impl::nleqstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_nleqstate_owner& _nleqstate_owner::operator=(const _nleqstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_nleqstate_clear(p_struct);
    if( !spd_alglib_impl::_nleqstate_init_copy(p_struct, const_cast<spd_alglib_impl::nleqstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::nleqstate* _nleqstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::nleqstate* _nleqstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::nleqstate*>(p_struct);
}
...
{
    p_struct = (spd_alglib_impl::nleqreport*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::nleqreport), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_nleqreport_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_nleqreport_owner::_nleqreport_owner(const _nleqreport_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_nleqreport_init_copy(p_struct, const_cast<spd_alglib_impl::nleqreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_nleqreport_owner& _nleqreport_owner::operator=(const _nleqreport_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_nleqreport_clear(p_struct);
    if( !spd_alglib_impl::_nleqreport_init_copy(p_struct, const_cast<spd_alglib_impl::nleqreport*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::nleqreport* _nleqreport_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::nleqreport* _nleqreport_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::nleqreport*>(p_struct);
}
...
void nleqcreatelm(const ae_int_t n, const ae_int_t m, const real_1d_array &x, nleqstate &state)
{
    ...
    try
    {
        spd_alglib_impl::nleqcreatelm(n, m, const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void nleqsetcond(const nleqstate &state, const double epsf, const ae_int_t maxits)
{
    ...
    try
    {
        spd_alglib_impl::nleqsetcond(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), epsf, maxits, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void nleqsetxrep(const nleqstate &state, const bool needxrep)
{
    ...
    try
    {
        spd_alglib_impl::nleqsetxrep(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), needxrep, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void nleqsetstpmax(const nleqstate &state, const double stpmax)
{
    ...
    try
    {
        spd_alglib_impl::nleqsetstpmax(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), stpmax, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
bool nleqiteration(const nleqstate &state)
{
    ...
    try
    {
        ae_bool result = spd_alglib_impl::nleqiteration(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
    ...
    void *ptr)
{
    ...
    try
    {
        while( spd_alglib_impl::nleqiteration(state.c_ptr(), &_alglib_env_state) )
        {
            if( state.needf )
            {
...
void nleqresults(const nleqstate &state, real_1d_array &x, nleqreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::nleqresults(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::nleqreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void nleqresultsbuf(const nleqstate &state, real_1d_array &x, nleqreport &rep)
{
    ...
    try
    {
        spd_alglib_impl::nleqresultsbuf(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), const_cast<spd_alglib_impl::nleqreport*>(rep.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void nleqrestartfrom(const nleqstate &state, const real_1d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::nleqrestartfrom(const_cast<spd_alglib_impl::nleqstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
