...
#include "spd/alglibspd/alglibmisc.h"
...
{
    p_struct = (spd_alglib_impl::hqrndstate*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::hqrndstate), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_hqrndstate_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_hqrndstate_owner::_hqrndstate_owner(const _hqrndstate_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_hqrndstate_init_copy(p_struct, const_cast<spd_alglib_impl::hqrndstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_hqrndstate_owner& _hqrndstate_owner::operator=(const _hqrndstate_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_hqrndstate_clear(p_struct);
    if( !spd_alglib_impl::_hqrndstate_init_copy(p_struct, const_cast<spd_alglib_impl::hqrndstate*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::hqrndstate* _hqrndstate_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::hqrndstate* _hqrndstate_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::hqrndstate*>(p_struct);
}
...
void hqrndrandomize(hqrndstate &state)
{
    ...
    try
    {
        spd_alglib_impl::hqrndrandomize(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
...
void hqrndseed(const ae_int_t s1, const ae_int_t s2, hqrndstate &state)
{
    ...
    try
    {
        spd_alglib_impl::hqrndseed(s1, s2, const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
double hqrnduniformr(const hqrndstate &state)
{
    ...
    try
    {
        double result = spd_alglib_impl::hqrnduniformr(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
...
ae_int_t hqrnduniformi(const hqrndstate &state, const ae_int_t n)
{
    ...
    try
    {
        spd_alglib_impl::ae_int_t result = spd_alglib_impl::hqrnduniformi(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), n, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
...
double hqrndnormal(const hqrndstate &state)
{
    ...
    try
    {
        double result = spd_alglib_impl::hqrndnormal(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<double*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
void hqrndunit2(const hqrndstate &state, double &x, double &y)
{
    ...
    try
    {
        spd_alglib_impl::hqrndunit2(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), &x, &y, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void hqrndnormal2(const hqrndstate &state, double &x1, double &x2)
{
    ...
    try
    {
        spd_alglib_impl::hqrndnormal2(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), &x1, &x2, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
double hqrndexponential(const hqrndstate &state, const double lambdav)
{
    ...
    try
    {
        double result = spd_alglib_impl::hqrndexponential(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), lambdav, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<double*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
double hqrnddiscrete(const hqrndstate &state, const real_1d_array &x, const ae_int_t n)
{
    ...
    try
    {
        double result = spd_alglib_impl::hqrnddiscrete(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<double*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
double hqrndcontinuous(const hqrndstate &state, const real_1d_array &x, const ae_int_t n)
{
    ...
    try
    {
        double result = spd_alglib_impl::hqrndcontinuous(const_cast<spd_alglib_impl::hqrndstate*>(state.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<double*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
{
    p_struct = (spd_alglib_impl::kdtree*)spd_alglib_impl::ae_malloc(sizeof(spd_alglib_impl::kdtree), NULL);
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_kdtree_init(p_struct, NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_kdtree_owner::_kdtree_owner(const _kdtree_owner &rhs)
{
    ...
    if( p_struct==NULL )
        throw ap_error("ALGLIB: malloc error");
    if( !spd_alglib_impl::_kdtree_init_copy(p_struct, const_cast<spd_alglib_impl::kdtree*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
}
...
_kdtree_owner& _kdtree_owner::operator=(const _kdtree_owner &rhs)
{
    if( this==&rhs )
        return *this;
    spd_alglib_impl::_kdtree_clear(p_struct);
    if( !spd_alglib_impl::_kdtree_init_copy(p_struct, const_cast<spd_alglib_impl::kdtree*>(rhs.p_struct), NULL, ae_false) )
        throw ap_error("ALGLIB: malloc error");
    return *this;
}
...
spd_alglib_impl::kdtree* _kdtree_owner::c_ptr()
{
    return p_struct;
}

spd_alglib_impl::kdtree* _kdtree_owner::c_ptr() const
{
    return const_cast<spd_alglib_impl::kdtree*>(p_struct);
}
...
{
    spd_alglib_impl::ae_state state;
    spd_alglib_impl::ae_serializer serializer;
    spd_alglib_impl::ae_int_t ssize;

    spd_alglib_impl::ae_state_init(&state);
    try
    {
        spd_alglib_impl::ae_serializer_init(&serializer);
        spd_alglib_impl::ae_serializer_alloc_start(&serializer);
        spd_alglib_impl::kdtreealloc(&serializer, obj.c_ptr(), &state);
        ssize = spd_alglib_impl::ae_serializer_get_alloc_size(&serializer);
        s_out.clear();
        s_out.reserve((size_t)(ssize+1));
        spd_alglib_impl::ae_serializer_sstart_str(&serializer, &s_out);
        spd_alglib_impl::kdtreeserialize(&serializer, obj.c_ptr(), &state);
        spd_alglib_impl::ae_serializer_stop(&serializer);
        if( s_out.length()>(size_t)ssize )
            throw ap_error("ALGLIB: serialization integrity error");
        spd_alglib_impl::ae_serializer_clear(&serializer);
        spd_alglib_impl::ae_state_clear(&state);
    }
    catch(spd_alglib_impl::ae_error_type)
    {
...
void kdtreeunserialize(std::string &s_in, kdtree &obj)
{
    ...
    {
        spd_alglib_impl::ae_serializer_init(&serializer);
        spd_alglib_impl::ae_serializer_ustart_str(&serializer, &s_in);
        spd_alglib_impl::kdtreeunserialize(&serializer, obj.c_ptr(), &state);
        spd_alglib_impl::ae_serializer_stop(&serializer);
        spd_alglib_impl::ae_serializer_clear(&serializer);
        spd_alglib_impl::ae_state_clear(&state);
    }
...
void kdtreebuild(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const ae_int_t ny, const ae_int_t normtype, kdtree &kdt)
{
    ...
    try
    {
        spd_alglib_impl::kdtreebuild(const_cast<spd_alglib_impl::ae_matrix*>(xy.c_ptr()), n, nx, ny, normtype, const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreebuildtagged(const real_2d_array &xy, const integer_1d_array &tags, const ae_int_t n, const ae_int_t nx, const ae_int_t ny, const ae_int_t normtype, kdtree &kdt)
{
    ...
    try
    {
        spd_alglib_impl::kdtreebuildtagged(const_cast<spd_alglib_impl::ae_matrix*>(xy.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(tags.c_ptr()), n, nx, ny, normtype, const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
ae_int_t kdtreequeryknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch)
{
    ...
    try
    {
        spd_alglib_impl::ae_int_t result = spd_alglib_impl::kdtreequeryknn(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), k, selfmatch, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<ae_int_t*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const double r, const bool selfmatch)
{
    ...
    try
    {
        spd_alglib_impl::ae_int_t result = spd_alglib_impl::kdtreequeryrnn(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), r, selfmatch, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<ae_int_t*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const double eps)
{
    ...
    try
    {
        spd_alglib_impl::ae_int_t result = spd_alglib_impl::kdtreequeryaknn(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(x.c_ptr()), k, selfmatch, eps, &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<ae_int_t*>(&result));
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultsx(const kdtree &kdt, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultsx(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultsxy(const kdtree &kdt, real_2d_array &xy)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultsxy(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(xy.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultstags(const kdtree &kdt, integer_1d_array &tags)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultstags(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(tags.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultsdistances(const kdtree &kdt, real_1d_array &r)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultsdistances(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(r.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultsxi(const kdtree &kdt, real_2d_array &x)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultsxi(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(x.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultsxyi(const kdtree &kdt, real_2d_array &xy)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultsxyi(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_matrix*>(xy.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultstagsi(const kdtree &kdt, integer_1d_array &tags)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultstagsi(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(tags.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
...
void kdtreequeryresultsdistancesi(const kdtree &kdt, real_1d_array &r)
{
    ...
    try
    {
        spd_alglib_impl::kdtreequeryresultsdistancesi(const_cast<spd_alglib_impl::kdtree*>(kdt.c_ptr()), const_cast<spd_alglib_impl::ae_vector*>(r.c_ptr()), &_alglib_env_state);
        spd_alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
    }
    catch(spd_alglib_impl::ae_error_type)
