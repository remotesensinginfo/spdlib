...
namespace spdlib{ namespace nn{
    ...
    delaunay* delaunay_build(int np, point points[], int ns, int segments[], int nh, double holes[])
    {
        ...
        spdlib::nn::triangulateio tio_in;
        spdlib::nn::triangulateio tio_out;
        char cmd[64] = "eznC";
        int i, j;
         ...
         * climax 
         */
        spdlib::nn::triangulate(cmd, &tio_in, &tio_out, (spdlib::nn::triangulateio*)NULL);
