...
int main (int argc, char * const argv[]) 
{
	...
	try 
	{
		...
		if(interpSwitch.getValue())
		{
            ...
            {
                interpolator = new spdlib::SPDNaturalNeighborPointInterpolator(spdlib::SPD_USE_Z, thinGridResArg.getValue(), thinSwitch.getValue(), spdlib::SPD_SELECT_LOWEST, noPtsPerBinArg.getValue());
            }
