...
>>> END OF LICENSE >>>
*************************************************************************/
#ifndef _spd_linalg_pkg_h
#define _spd_linalg_pkg_h
...
public:
    ...
    spd_alglib_impl::matinvreport* c_ptr();
    spd_alglib_impl::matinvreport* c_ptr() const;
protected:
    spd_alglib_impl::matinvreport *p_struct;
};
...
public:
    ...
    spd_alglib_impl::sparsematrix* c_ptr();
    spd_alglib_impl::sparsematrix* c_ptr() const;
protected:
    spd_alglib_impl::sparsematrix *p_struct;
};
...
public:
    ...
    spd_alglib_impl::normestimatorstate* c_ptr();
    spd_alglib_impl::normestimatorstate* c_ptr() const;
protected:
    spd_alglib_impl::normestimatorstate *p_struct;
};
...
*************************************************************************/
void cmatrixgemm(const ae_int_t m, const ae_int_t n, const ae_int_t k, const spd_alglib::complex alpha, const complex_2d_array &a, const ae_int_t ia, const ae_int_t ja, const ae_int_t optypea, const complex_2d_array &b, const ae_int_t ib, const ae_int_t jb, const ae_int_t optypeb, const spd_alglib::complex beta, const complex_2d_array &c, const ae_int_t ic, const ae_int_t jc);
void smp_cmatrixgemm(const ae_int_t m, const ae_int_t n, const ae_int_t k, const spd_alglib::complex alpha, const complex_2d_array &a, const ae_int_t ia, const ae_int_t ja, const ae_int_t optypea, const complex_2d_array &b, const ae_int_t ib, const ae_int_t jb, const ae_int_t optypeb, const spd_alglib::complex beta, const complex_2d_array &c, const ae_int_t ic, const ae_int_t jc);
...
Result: matrix determinant.
  ...
  -- ALGLIB --
     Copyright 2005 by Bochkanov Sergey
*************************************************************************/
spd_alglib::complex cmatrixludet(const complex_2d_array &a, const integer_1d_array &pivots, const ae_int_t n);
spd_alglib::complex cmatrixludet(const complex_2d_array &a, const integer_1d_array &pivots);
...
Result: determinant of matrix A.
  ...
  -- ALGLIB --
     Copyright 2005 by Bochkanov Sergey
*************************************************************************/
spd_alglib::complex cmatrixdet(const complex_2d_array &a, const ae_int_t n);
spd_alglib::complex cmatrixdet(const complex_2d_array &a);
