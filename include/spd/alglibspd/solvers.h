...
>>> END OF LICENSE >>>
*************************************************************************/
#ifndef _spd_solvers_pkg_h
#define _spd_solvers_pkg_h
...
public:
    ...
    spd_alglib_impl::densesolverreport* c_ptr();
    spd_alglib_impl::densesolverreport* c_ptr() const;
protected:
    spd_alglib_impl::densesolverreport *p_struct;
};
...
public:
    ...
    spd_alglib_impl::densesolverlsreport* c_ptr();
    spd_alglib_impl::densesolverlsreport* c_ptr() const;
protected:
    spd_alglib_impl::densesolverlsreport *p_struct;
};
...
public:
    ...
    spd_alglib_impl::linlsqrstate* c_ptr();
    spd_alglib_impl::linlsqrstate* c_ptr() const;
protected:
    spd_alglib_impl::linlsqrstate *p_struct;
};
...
public:
    ...
    spd_alglib_impl::linlsqrreport* c_ptr();
    spd_alglib_impl::linlsqrreport* c_ptr() const;
protected:
    spd_alglib_impl::linlsqrreport *p_struct;
};
...
public:
    ...
    spd_alglib_impl::lincgstate* c_ptr();
    spd_alglib_impl::lincgstate* c_ptr() const;
protected:
    spd_alglib_impl::lincgstate *p_struct;
};
...
public:
    ...
    spd_alglib_impl::lincgreport* c_ptr();
    spd_alglib_impl::lincgreport* c_ptr() const;
protected:
    spd_alglib_impl::lincgreport *p_struct;
};
...
public:
    ...
    spd_alglib_impl::nleqstate* c_ptr();
    spd_alglib_impl::nleqstate* c_ptr() const;
protected:
    spd_alglib_impl::nleqstate *p_struct;
};
...
public:
    ...
    spd_alglib_impl::nleqreport* c_ptr();
    spd_alglib_impl::nleqreport* c_ptr() const;
protected:
    spd_alglib_impl::nleqreport *p_struct;
};
