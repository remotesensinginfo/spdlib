...
typedef spd_alglib_impl::ae_int_t ae_int_t;
...
const spd_alglib::complex operator/(const spd_alglib::complex& lhs, const spd_alglib::complex& rhs);
const bool operator==(const spd_alglib::complex& lhs, const spd_alglib::complex& rhs);
const bool operator!=(const spd_alglib::complex& lhs, const spd_alglib::complex& rhs);
const spd_alglib::complex operator+(const spd_alglib::complex& lhs);
const spd_alglib::complex operator-(const spd_alglib::complex& lhs);
const spd_alglib::complex operator+(const spd_alglib::complex& lhs, const spd_alglib::complex& rhs);
const spd_alglib::complex operator+(const spd_alglib::complex& lhs, const double& rhs);
const spd_alglib::complex operator+(const double& lhs, const spd_alglib::complex& rhs);
const spd_alglib::complex operator-(const spd_alglib::complex& lhs, const spd_alglib::complex& rhs);
const spd_alglib::complex operator-(const spd_alglib::complex& lhs, const double& rhs);
const spd_alglib::complex operator-(const double& lhs, const spd_alglib::complex& rhs);
const spd_alglib::complex operator*(const spd_alglib::complex& lhs, const spd_alglib::complex& rhs);
...
const spd_alglib::complex operator/(const double& lhs, const spd_alglib::complex& rhs);
const spd_alglib::complex operator/(const spd_alglib::complex& lhs, const double& rhs);
double abscomplex(const spd_alglib::complex &z);
spd_alglib::complex conj(const spd_alglib::complex &z);
spd_alglib::complex csqr(const spd_alglib::complex &z);
void setnworkers(spd_alglib::ae_int_t nworkers);
...
spd_alglib::complex vdotproduct(const spd_alglib::complex *v0, ae_int_t stride0, const char *conj0, const spd_alglib::complex *v1, ae_int_t stride1, const char *conj1, ae_int_t n);
spd_alglib::complex vdotproduct(const spd_alglib::complex *v1, const spd_alglib::complex *v2, ae_int_t N);
...
void vmove(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex* vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n);
void vmove(spd_alglib::complex *vdst, const spd_alglib::complex* vsrc, ae_int_t N);
...
void vmoveneg(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex* vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n);
void vmoveneg(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N);
...
void vmove(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex* vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, double alpha);
void vmove(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N, double alpha);

void vmove(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex* vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, spd_alglib::complex alpha);
void vmove(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N, spd_alglib::complex alpha);
...
void vadd(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n);
void vadd(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N);
...
void vadd(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, double alpha);
void vadd(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N, double alpha);

void vadd(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, spd_alglib::complex alpha);
void vadd(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N, spd_alglib::complex alpha);
...
void vsub(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n);
void vsub(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N);
...
void vsub(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, double alpha);
void vsub(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N, double alpha);

void vsub(spd_alglib::complex *vdst, ae_int_t stride_dst, const spd_alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, spd_alglib::complex alpha);
void vsub(spd_alglib::complex *vdst, const spd_alglib::complex *vsrc, ae_int_t N, spd_alglib::complex alpha);

void vmul(double *vdst,  ae_int_t stride_dst, ae_int_t n, double alpha);
void vmul(double *vdst, ae_int_t N, double alpha);

void vmul(spd_alglib::complex *vdst, ae_int_t stride_dst, ae_int_t n, double alpha);
void vmul(spd_alglib::complex *vdst, ae_int_t N, double alpha);

void vmul(spd_alglib::complex *vdst, ae_int_t stride_dst, ae_int_t n, spd_alglib::complex alpha);
void vmul(spd_alglib::complex *vdst, ae_int_t N, spd_alglib::complex alpha);
...
public:
    ...
    void attach_to(spd_alglib_impl::ae_vector *ptr);
    void allocate_own(ae_int_t size, spd_alglib_impl::ae_datatype datatype);
    const spd_alglib_impl::ae_vector* c_ptr() const;
    spd_alglib_impl::ae_vector* c_ptr();
private:
...
public:
    ...
    boolean_1d_array(spd_alglib_impl::ae_vector *p);
...
public:
    ...
    integer_1d_array(spd_alglib_impl::ae_vector *p);
...
public:
    ...
    real_1d_array(spd_alglib_impl::ae_vector *p);
...
public:
    ...
    complex_1d_array(spd_alglib_impl::ae_vector *p);
    const complex_1d_array& operator=(const complex_1d_array &rhs);
    virtual ~complex_1d_array();

    const spd_alglib::complex& operator()(ae_int_t i) const;
    spd_alglib::complex& operator()(ae_int_t i);

    const spd_alglib::complex& operator[](ae_int_t i) const;
    spd_alglib::complex& operator[](ae_int_t i);

    void setcontent(ae_int_t iLen, const spd_alglib::complex *pContent );
    spd_alglib::complex* getcontent();
    const spd_alglib::complex* getcontent() const;
...
public:
    ...
    void attach_to(spd_alglib_impl::ae_matrix *ptr);
    void allocate_own(ae_int_t rows, ae_int_t cols, spd_alglib_impl::ae_datatype datatype);
    const spd_alglib_impl::ae_matrix* c_ptr() const;
    spd_alglib_impl::ae_matrix* c_ptr();
private:
...
public:
    ...
    boolean_2d_array(spd_alglib_impl::ae_matrix *p);
...
public:
    ...
    integer_2d_array(spd_alglib_impl::ae_matrix *p);
...
public:
    ...
    real_2d_array(spd_alglib_impl::ae_matrix *p);
...
public:
    ...
    complex_2d_array(spd_alglib_impl::ae_matrix *p);
    complex_2d_array(const char *s);
    virtual ~complex_2d_array();

    const spd_alglib::complex& operator()(ae_int_t i, ae_int_t j) const;
    spd_alglib::complex& operator()(ae_int_t i, ae_int_t j);

    const spd_alglib::complex* operator[](ae_int_t i) const;
    spd_alglib::complex* operator[](ae_int_t i);

    void setcontent(ae_int_t irows, ae_int_t icols, const spd_alglib::complex *pContent );
...
public:
    ...
    spd_alglib::real_2d_array trn;
    spd_alglib::real_2d_array val;
    spd_alglib::real_2d_array tst;
    spd_alglib::real_2d_array all;
};
