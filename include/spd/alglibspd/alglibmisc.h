...
>>> END OF LICENSE >>>
*************************************************************************/
#ifndef _spd_alglibmisc_pkg_h
#define _spd_alglibmisc_pkg_h
...
public:
    ...
    spd_alglib_impl::hqrndstate* c_ptr();
    spd_alglib_impl::hqrndstate* c_ptr() const;
protected:
    spd_alglib_impl::hqrndstate *p_struct;
};
...
public:
    ...
    spd_alglib_impl::kdtree* c_ptr();
    spd_alglib_impl::kdtree* c_ptr() const;
protected:
    spd_alglib_impl::kdtree *p_struct;
};
