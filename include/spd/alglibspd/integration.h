...
>>> END OF LICENSE >>>
*************************************************************************/
#ifndef _spd_integration_pkg_h
#define _spd_integration_pkg_h
...
public:
    ...
    spd_alglib_impl::autogkreport* c_ptr();
    spd_alglib_impl::autogkreport* c_ptr() const;
protected:
    spd_alglib_impl::autogkreport *p_struct;
};
...
public:
    ...
    spd_alglib_impl::autogkstate* c_ptr();
    spd_alglib_impl::autogkstate* c_ptr() const;
protected:
    spd_alglib_impl::autogkstate *p_struct;
};
